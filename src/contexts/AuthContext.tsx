import { createUserWithEmailAndPassword, signOut as firebaseSignOut, signInWithEmailAndPassword, updateProfile } from "firebase/auth";
...
export function AuthContextProvider({ children }: AuthContextProviderProps) {
  ...
  return (
    <AuthContext.Provider value={{ user: data.user, signIn, signOut, createUser, authenticated }}>
      {children}
